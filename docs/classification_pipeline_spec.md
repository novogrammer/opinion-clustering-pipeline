...
- `data/processed/responses_normalized.csv`
- `data/processed/embedding_inputs.csv`
- `data/embeddings/embeddings_{question_id}.npy`
- `data/embeddings/embedding_metadata_{question_id}.json`
- `data/clustering/clusters_{question_id}.csv`
- `data/clustering/cluster_summary_{question_id}.csv`
- `data/classification/final_labels_{question_id}.csv`
