...
- `03_embeddings/` に `embedding_requests.csv`, `embeddings.npy`, `embedding_metadata.json`
- API 失敗時は `03_embeddings/embedding_failures.csv` に失敗レコードを残す
- `04_clustering/` に `clusters.csv`, `cluster_summary.csv`, `clustering_metadata.json`
